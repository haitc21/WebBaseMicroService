...
using WebBase.IDP.STS.Identity.Configuration;
using WebBase.IDP.STS.Identity.Configuration.ApplicationParts;
using WebBase.IDP.STS.Identity.Configuration.Constants;
using WebBase.IDP.STS.Identity.Configuration.Interfaces;
using WebBase.IDP.STS.Identity.Helpers.Localization;

namespace WebBase.IDP.STS.Identity.Helpers
{
